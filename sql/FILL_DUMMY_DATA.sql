...
--GRAB ALL THE NECESSARY ID's to use a foreign keys for _Event

SELECT * FROM Sponsor WHERE


#INSERT INTO _Event (User_email,Venue_id,University_id,Deadline,Event_name,Event_description,Start_date_time,End_date_time,Event_type)
#VALUES ("michaelball357@gmail.com",")